...
\begin{definition}[Ciclo]
    Un cammino è detto \textit{ciclo}, o \textit{circuito}, o \textit{cammino chiuso}, se è della forma $v_0, e_1, v_1, e_2, \ldots , e_{n - 1}, v_{n - 1}, e_n, v_0$, dunque il primo e l'ultimo vertice coincidono.
\end{definition}
